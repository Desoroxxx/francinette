...
# download github
git clone --recursive https://github.com/desoroxxx/francinette.git
...
printf "\033[33m... and don't forget, francinette is not a replacement for your own tests! \033[0m\n"
