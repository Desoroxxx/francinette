...
```
bash -c "$(curl -fsSL https://raw.github.com/Desoroxxx/francinette/master/bin/install.sh)"
```
...
```
bash -c "$(curl -fsSL https://raw.github.com/Desoroxxx/francinette/master/bin/update.sh)"
```
